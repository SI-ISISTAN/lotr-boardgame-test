define(['https://code.jquery.com/jquery-1.8.3.js'], function(jquery){
	...
	$(document).ready(function(){
		...
		countries = document.querySelector("#users-selector");
